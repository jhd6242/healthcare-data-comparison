...
setwd("/users/jdecross/Development/Healthcare Data Comparison/dev-app")
...
work_book2 <- 
  select(work_book1, National.Provider.Indentification, Plan.Name, Standardized.Add.1, Standardized.City, Standardized.State, 
         Standardized.County.Name, Standardized.ZIP, License.Number,Medicaid.Provider.Identification.No, Provider.Primary.Specialty, Phone.Number)%>%
  arrange(National.Provider.Indentification, Standardized.Add.1, Standardized.City, Standardized.State, Standardized.County.Name, Standardized.ZIP)
...
write.xlsx(remove_individual_npi, "/users/jdecross/Development/Healthcare Data Comparison/dev-app/remove_individual_npi.xlsx")
